...
# Download WordPress
RUN curl -L "https://wordpress.org/wordpress-4.2.1.tar.gz" > /wordpress-4.2.1.tar.gz && \
    rm /var/www/html/index.html && \
    tar -xzf /wordpress-4.2.1.tar.gz -C /var/www/html --strip-components=1 && \
    rm /wordpress-4.2.1.tar.gz
